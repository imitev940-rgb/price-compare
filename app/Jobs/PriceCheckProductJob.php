        ...
        try {
            ...
            foreach ($dataRows as $index => $row) {
                ...
                try {
                    ...
                    if (Schema::hasColumn('products', 'scan_priority') && ! empty($data['scan_priority'])) {
                        $scanPriority = strtolower(trim((string) $data['scan_priority']));
                        $productData['scan_priority'] = $scanPriority === 'top' ? 'top' : 'normal';
                    }
